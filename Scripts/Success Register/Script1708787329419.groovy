...
WebUI.setText(findTestObject('Object Repository/Register/input_nama toko_name'), namaToko)

WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'tokobarusayates@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), 'fbOwUogQc5E/WJzJPjVlOg==')
